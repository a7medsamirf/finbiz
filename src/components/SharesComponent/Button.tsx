...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary:"bg-primary text-white overflow-hidden group hover:bg-gradient-to-r hover:from-lime-400 hover:to-lime-400 hover:ring-2 hover:ring-offset-2 hover:ring-green-400 transition-all ease-out duration-300",
